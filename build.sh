...
ZIPNAME="villhazekernel-ruby-tvendor-$(date '+%Y%m%d-%H%M').zip"
TC_DIR="/home/lucifer/cos/xrage"
AK3_DIR="/home/lucifer/cos/AnyKernel3"
DEFCONFIG="ruby_user_defconfig"
...
elif ! git clone -q -b ruby https://github.com/fjrXTR/AnyKernel3; then
